...
grayframe = cv2.cvtColor(test_img,cv2.COLOR_RGB2GRAY) #replace me
...
if len(good_points) > 20:
    ...
    # (https://docs.opencv.org/master/d9/d0c/grkeyframeoup__calib3d.html)
    ...
    ##--your-code-starts-here--##
    im_warped = cv2.warpPerspective(grayframe, matrix, dsize=(720, 540)) # replace me
    ##--your-code-ends-here--##
